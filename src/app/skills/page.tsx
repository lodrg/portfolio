    ...
    <div className="pt-20">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">My Learning Journey</h2>
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <h3 className="text-gray-900 dark:text-white">Design Philosophy</h3>
            <p className="text-gray-600 dark:text-gray-300">
            ...
            <h3 className="text-gray-900 dark:text-white">Development Approach</h3>
            <p className="text-gray-600 dark:text-gray-300">
            ...
            <h3 className="text-gray-900 dark:text-white">Data & Machine Learning</h3>
            <p className="text-gray-600 dark:text-gray-300">
